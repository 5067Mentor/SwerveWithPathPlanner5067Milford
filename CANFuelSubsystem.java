...
public class CANFuelSubsystem extends SubsystemBase {
  ...
  public CANFuelSubsystem() {
    ...
    intakeLauncherRoller = new SparkMax(INTAKE_LAUNCHER_MOTOR_ID, MotorType.kBrushless); //KP verify these are the new neos
    feederRoller = new SparkMax(FEEDER_MOTOR_ID, MotorType.kBrushless); //KP verify these are the new motors
  ...
  // subsystem
  public Command launchCommand(double spinUpSeconds) {
    return run(this::spinUp).withTimeout(spinUpSeconds)
      .andThen(run(this::shoot));
  }

  public Command launchCommand() {
    return launchCommand(SPIN_UP_SECONDS);
  }
  ...
  public Command intakeCommand() {
    return intakeCommand(SmartDashboard.getNumber("Intaking intake roller value", INTAKING_INTAKE_VOLTAGE));
  }
